...
class ExceptionCode
{
    ...
    public const INFRASTRUCTURE_FAILED_TO_INSTALL_MBO_INSTALLER = 1003;
    public const INFRASTRUCTURE_FAILED_TO_INSTALL_DEPENDENCIES = 1004;
    public const INFRASTRUCTURE_FAILED_TO_RETRIEVE_MODULE_MANAGER_BUILDER = 1005;
    public const INFRASTRUCTURE_FAILED_TO_INSTALL_PRESTASHOP_ACCOUNTS = 1006;
    public const INFRASTRUCTURE_FAILED_TO_INSTALL_PRESTASHOP_EVENT_BUS = 1007;
